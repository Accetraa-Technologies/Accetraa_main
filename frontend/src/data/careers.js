// ─── Why join us ──────────────────────────────────────────────────────────────
// Used by Careers/WhyJoinUs section.
// `iconKey` maps to local SVG components defined in that file.
...
// ─── Employee benefits ────────────────────────────────────────────────────────
// Used by Careers/Benefits section.
// `iconKey` maps to local SVG components defined in that file.
...
// ─── Culture stats ────────────────────────────────────────────────────────────
// Used by Careers/LifeAtAccetraa section.
...
// ─── Culture values ───────────────────────────────────────────────────────────
// Used by Careers/LifeAtAccetraa section — bullet list.
